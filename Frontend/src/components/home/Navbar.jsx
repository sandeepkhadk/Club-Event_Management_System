...
const Navbar = () => {
  ...
  return (
    <nav className="bg-slate-900 text-white px-6 py-4 sticky top-0 z-\[100\] shadow-lg">
      <div className="max-w-7xl mx-auto flex items-center justify-between">
        ...
        <ul className="hidden lg:flex items-center gap-8 text-sm font-medium">
          ...
          <Link to="/events" className="hover:text-cyan-400 transition">Events</Link>
          <Link to="/clubs" className="hover:text-cyan-400 transition">Clubs</Link>
          <Link to="/contact" className="hover:text-cyan-400 transition">Contact</Link>
        </ul>

        {/* Desktop Action Buttons */}
        <div className="hidden lg:flex items-center gap-4">
          <Link to="/login" className="text-sm font-semibold hover:text-cyan-400 transition">Login</Link>
