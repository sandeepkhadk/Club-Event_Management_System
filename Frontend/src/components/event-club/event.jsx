    ...
    <div className="min-h-screen bg-slate-50 font-sans text-slate-800">
      ...
      <main className="max-w-7xl mx-auto px-4 sm:px-6 -mt-20 pb-20 relative z-20 grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
        {events.length > 0 ? events.map((event) => (
          <div key={event.id} className="group bg-white rounded-[2.5rem] shadow-xl shadow-slate-200/50 overflow-hidden border border-white hover:border-indigo-100 transition-all duration-500 hover:-translate-y-3">
