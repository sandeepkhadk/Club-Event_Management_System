            ...
            <div className="p-8 space-y-5">
              ...
              <div className="pt-4 border-t border-slate-50 flex items-center justify-between">
                ...
                <button
                  ...
                  className="flex items-center gap-2 bg-slate-900 text-white px-5 py-3 rounded-2xl cursor-pointer font-bold text-sm hover:bg-indigo-600 transition-all active:scale-95 shadow-lg shadow-slate-200 hover:shadow-indigo-200"
                >
      ...
      {selectedEvent && (
        <div className="fixed inset-0 bg-slate-900/60 backdrop-blur-2xl flex items-center justify-center z-50 p-4">
          <div className="bg-white/95 backdrop-blur-3xl rounded-3xl p-8 w-full max-w-3xl max-h-[90vh] overflow-y-auto shadow-xl relative">
            <button onClick={() => setSelectedEvent(null)} className="absolute top-6 right-6 p-3 bg-white/70 rounded-3xl shadow-xl cursor-pointer">
            ...
            {token ? (
              <form onSubmit={handleJoin} className="space-y-4">
                ...
                <button
                  type="submit"
                  disabled={joining}
                  className="w-full py-4 bg-indigo-600 text-white rounded-2xl font-bold hover:bg-indigo-700 transition-all flex items-center justify-center gap-2 cursor-pointer"
                >
